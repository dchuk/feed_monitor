require_relative "lib/feedmon/version"

Gem::Specification.new do |spec|
  spec.name        = "feedmon"
  spec.version     = Feedmon::VERSION
  spec.authors     = [ "dchuk" ]
  spec.email       = [ "me@dchuk.com" ]
  spec.homepage    = "https://github.com/dchuk/feedmon"
  spec.summary     = "Feedmon engine for ingesting, scraping, and monitoring RSS/Atom/JSON feeds"
  spec.description = "Feedmon is a mountable Rails 8 engine that ingests RSS, Atom, and JSON feeds, scrapes full article content, and surfaces Solid Queue powered dashboards for monitoring and remediation."
  spec.license     = "MIT"

  spec.required_ruby_version = ">= 3.4.0"
  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = spec.homepage
  spec.metadata["changelog_uri"] = "https://github.com/dchuk/feedmon/blob/main/CHANGELOG.md"
  spec.metadata["documentation_uri"] = "https://github.com/dchuk/feedmon#readme"
  spec.metadata["bug_tracker_uri"] = "https://github.com/dchuk/feedmon/issues"
