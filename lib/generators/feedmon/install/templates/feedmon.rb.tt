...
Feedmon.configure do |config|
  ...
  config.queue_namespace = "feedmon"
  ...
  # Feedmon assumes Solid Queue handles persistence. Run
  ...
  # Toggle Feedmon's lightweight queue visibility layer. When enabled (the
  ...
  # "Open Mission Control" link on the Feedmon dashboard.
  ...
  # ---- Authentication -----------------------------------------------------
  # Hook Feedmon into your host application's authentication stack. Each
  ...
  # Merge extra default headers (User-Agent defaults to Feedmon/version).
  ...
  # Tune how many fetches Feedmon evaluates when determining health
  ...
  # inherit from Feedmon::Scrapers::Base.
  ...
  # ---- Model extensions --------------------------------------------------
  # Host applications can extend Feedmon models without monkey patches.
  # Table names default to "feedmon_*"; override when multi-tenancy or
  # legacy naming requires a different prefix.
  # config.models.table_name_prefix = "feedmon_"
  #
  # Include extension concerns to add associations, scopes, or helper methods.
  # config.models.source.include_concern "MyApp::Feedmon::SourceExtensions"
  #
  ...
  # config.realtime.redis_url = ENV.fetch("FEEDMON_REDIS_URL", nil)
