...
module Feedmon
  class Configuration
    ...
    DEFAULT_QUEUE_NAMESPACE = "feedmon"
    ...
    class ScraperRegistry
      ...
      def normalize_adapter(adapter)
        ...
        if defined?(Feedmon::Scrapers::Base) && !(constant <= Feedmon::Scrapers::Base)
          raise ArgumentError, "Scraper adapters must inherit from Feedmon::Scrapers::Base"
        end
    ...
    class RetentionSettings
      ...
      def normalize_strategy(value)
        ...
        if value.respond_to?(:to_sym)
          ...
          valid =
            if defined?(Feedmon::Items::RetentionPruner::VALID_STRATEGIES)
              Feedmon::Items::RetentionPruner::VALID_STRATEGIES
            else
