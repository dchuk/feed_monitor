...
module Feedmon
  module Scrapers
    class Readability < Base
      ...
      FETCHER_CLASS = Feedmon::Scrapers::Fetchers::HttpFetcher
      PARSER_CLASS = Feedmon::Scrapers::Parsers::ReadabilityParser
      ...
      def self.default_settings
        {
          http: {
            headers: {
              ...
              "User-Agent" => Feedmon::HTTP::DEFAULT_USER_AGENT
            },
            timeout: Feedmon::HTTP::DEFAULT_TIMEOUT,
            open_timeout: Feedmon::HTTP::DEFAULT_OPEN_TIMEOUT,
            proxy: nil
          },
          selectors: {
            content: nil,
