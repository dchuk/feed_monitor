  ...
  module Scrapers
    module Fetchers
      class HttpFetcher
        ...
        def initialize(http: Feedmon::HTTP)
          @http = http
        end
        ...
        def connection(settings)
          ...
          http.client(
            ...
            timeout: normalized[:timeout] || Feedmon::HTTP::DEFAULT_TIMEOUT,
            open_timeout: normalized[:open_timeout] || Feedmon::HTTP::DEFAULT_OPEN_TIMEOUT
          )
        end
