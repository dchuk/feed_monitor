...
module Feedmon
  module Instrumentation
    FETCH_START_EVENT = "feedmon.fetch.start".freeze
    FETCH_FINISH_EVENT = "feedmon.fetch.finish".freeze
    ITEM_DUPLICATE_EVENT = "feedmon.items.duplicate".freeze
    ITEM_RETENTION_EVENT = "feedmon.items.retention".freeze
