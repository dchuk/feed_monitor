...
- [ ] Inspect `pkg/feedmon-<VERSION>.gem`:
...
- [ ] Smoke test the disposable host app harness:
  ...
  - [ ] `bin/rails runner 'Feedmon::FetchFeedJob'` in the dummy app if new background job behavior shipped.
...
- [ ] Publish the gem (`gem push pkg/feedmon-<VERSION>.gem`).
