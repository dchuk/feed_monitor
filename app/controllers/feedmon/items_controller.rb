...
module Feedmon
  class ItemsController < ApplicationController
    ...
    def index
      ...
      paginator = Feedmon::Pagination::Paginator.new(
        scope:,
        page: params[:page],
        per_page: PER_PAGE
      ).paginate
    ...
    def scrape
      ...
      enqueue_result = Feedmon::Scraping::Enqueuer.enqueue(item: @item, reason: :manual)
      log_manual_scrape(
      ...
      respond_to do |format|
        ...
        format.html do
          ...
          if flash_key && flash_message
            redirect_to feedmon.item_path(@item), flash: { flash_key => flash_message }
          else
            redirect_to feedmon.item_path(@item)
          end
        end
      end
    end
