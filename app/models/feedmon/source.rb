...
require "feedmon/models/sanitizable"
require "feedmon/models/url_normalizable"

module Feedmon
  class Source < ApplicationRecord
    include Feedmon::Models::Sanitizable
    include Feedmon::Models::UrlNormalizable
    ...
    has_many :fetch_logs, class_name: "Feedmon::FetchLog", inverse_of: :source, dependent: :destroy
    has_many :scrape_logs, class_name: "Feedmon::ScrapeLog", inverse_of: :source, dependent: :destroy
    has_many :health_check_logs, class_name: "Feedmon::HealthCheckLog", inverse_of: :source, dependent: :destroy
    has_many :log_entries, class_name: "Feedmon::LogEntry", inverse_of: :source, dependent: :destroy
    ...
    Feedmon::ModelExtensions.register(self, :source)
