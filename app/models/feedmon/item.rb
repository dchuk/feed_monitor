...
module Feedmon
  class Item < ApplicationRecord
    ...
    belongs_to :source, class_name: "Feedmon::Source", inverse_of: :items, counter_cache: true
    has_one :item_content, class_name: "Feedmon::ItemContent", inverse_of: :item, dependent: :destroy, autosave: true
    has_many :scrape_logs, class_name: "Feedmon::ScrapeLog", inverse_of: :item, dependent: :destroy
    has_many :log_entries, class_name: "Feedmon::LogEntry", inverse_of: :item, dependent: :destroy
    ...
    Feedmon::ModelExtensions.register(self, :item)
