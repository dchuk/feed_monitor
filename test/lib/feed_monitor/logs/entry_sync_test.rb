  ...
  module Logs
    class EntrySyncTest < ActiveSupport::TestCase
      test "returns nil when loggable is not persisted" do
        log = FeedMonitor::FetchLog.new

        assert_nil FeedMonitor::Logs::EntrySync.call(log)
      end
      ...
      test "syncs attributes to an existing log entry" do
        ...
        log = FeedMonitor::ScrapeLog.create!(
          source:,
          item:,
        ...
        FeedMonitor::Logs::EntrySync.call(log)
        entry = log.log_entry
      ...
      test "rescues persistence failures and returns nil" do
        ...
        assert_nil FeedMonitor::Logs::EntrySync.call(loggable)
      end
