      ...
      class PersistenceTest < ActiveSupport::TestCase
        test "persists successful adapter result and returns scraper result" do
          ...
          travel_to started_at do
            adapter_result = FeedMonitor::Scrapers::Base::Result.new(
              status: :success,
            ...
            persistence = FeedMonitor::Scraping::ItemScraper::Persistence.new(
              item:,
              source:,
            ...
            log = FeedMonitor::ScrapeLog.order(:created_at).last
