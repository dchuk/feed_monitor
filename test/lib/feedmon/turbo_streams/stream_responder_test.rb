  ...
  module TurboStreams
    class StreamResponderTest < ActiveSupport::TestCase
      ...
      test "records replace operations for resource details" do
        ...
        responder.replace_details(@source, partial: "feedmon/sources/details_wrapper", locals: { source: @source })
        ...
        assert_equal "feedmon/sources/details_wrapper", operation.partial
      ...
      test "records toast notification append" do
        ...
        assert_equal "feedmon_notifications", operation.target
        assert_equal "feedmon/shared/toast", operation.partial
      ...
      test "renders operations into turbo stream tags" do
        responder = Feedmon::TurboStreams::StreamResponder.new
        responder.append("custom_target", partial: "feedmon/shared/toast", locals: { message: "Hello", level: :info, title: nil, delay_ms: 1000 })

        controller = Feedmon::SourcesController.new
