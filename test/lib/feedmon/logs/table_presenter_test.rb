  ...
  module Logs
    class TablePresenterTest < ActiveSupport::TestCase
      ...
      def setup
        ...
        @fetch_log = Feedmon::FetchLog.create!(
          source: @source,
          success: true,
          http_status: 204,
          items_created: 5,
        ...
        @scrape_log = Feedmon::ScrapeLog.create!(
          source: @source,
          item: @item,
          success: false,
          http_status: 500,
        ...
        @health_check_log = Feedmon::HealthCheckLog.create!(
          source: @source,
          success: true,
          http_status: 200,
      ...
      test "builds typed row view models" do
        ...
        presenter = Feedmon::Logs::TablePresenter.new(
