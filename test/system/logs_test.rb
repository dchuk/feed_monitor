...
module SourceMonitor
  class LogsTest < ApplicationSystemTestCase
    setup do
      ...
      @success_fetch_log = SourceMonitor::FetchLog.create!(
        source: @source,
        success: true,
      ...
      @failure_fetch_log = SourceMonitor::FetchLog.create!(
        source: @source,
        success: false,
      ...
      @success_scrape_log = SourceMonitor::ScrapeLog.create!(
        source: @source,
        item: @item,
        success: true,
      ...
      @failure_scrape_log = SourceMonitor::ScrapeLog.create!(
        source: @source,
        item: @item,
        success: false,
        scraper_adapter: "readability",
    ...
    test "filtering consolidated logs by type and status" do
      visit source_monitor.logs_path
      ...
      assert_current_path source_monitor.scrape_log_path(@failure_scrape_log)
    end
