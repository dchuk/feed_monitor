...
module SourceMonitor
  class LogsControllerTest < ActionDispatch::IntegrationTest
    setup do
      ...
      @fetch_success = SourceMonitor::FetchLog.create!(
        source: @source,
        success: true,
        http_status: 200,
        items_created: 1,
      ...
      @scrape_failure = SourceMonitor::ScrapeLog.create!(
        source: @source,
        item: @item,
        success: false,
    ...
    test "filters by sanitized status and log type parameters" do
      get "/source_monitor/logs", params: { status: "failed<script>", log_type: "scrape<script>" }
    ...
    test "applies sanitized search parameter" do
      get "/source_monitor/logs", params: { search: "OK<script>" }
    ...
    test "ignores invalid timeframe and source filters" do
      get "/source_monitor/logs", params: {
