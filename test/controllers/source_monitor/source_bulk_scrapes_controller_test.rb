...
module SourceMonitor
  class SourceBulkScrapesControllerTest < ActionDispatch::IntegrationTest
    ...
    test "queues bulk scrape and renders turbo stream" do
      ...
      result = SourceMonitor::Scraping::BulkSourceScraper::Result.new(
        status: :success,
        selection: :current,
        attempted_count: 2,
        enqueued_count: 2,
      ...
      SourceMonitor::Scraping::BulkSourceScraper.stub(:new, ->(*) { scraper }) do
        post source_monitor.source_bulk_scrape_path(source),
