...
module Feedmon
  class AdvancedTemplateTest < ActiveSupport::TestCase
    TEMPLATE_PATH = Feedmon::Engine.root.join("examples/advanced_host/template.rb")
    ...
    test "template copies instrumentation initializer" do
      ...
      assert_includes source, "feedmon_instrumentation.rb", "expected instrumentation initializer to be copied"
    end
  end
end
