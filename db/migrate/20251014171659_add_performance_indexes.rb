class AddPerformanceIndexes < ActiveRecord::Migration[8.0]
  def change
    ...
    unless index_exists?(:feedmon_items, [ :source_id, :created_at ], name: "index_items_on_source_and_created_at_for_rates")
      add_index :feedmon_items,
    ...
    unless index_exists?(:feedmon_sources, [ :active, :next_fetch_at ], name: "index_sources_on_active_and_next_fetch")
      add_index :feedmon_sources,
    ...
    unless index_exists?(:feedmon_sources, :failure_count, name: "index_sources_on_failures")
      add_index :feedmon_sources,
        :failure_count,
