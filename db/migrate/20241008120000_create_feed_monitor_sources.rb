...
class CreateFeedMonitorSources < ActiveRecord::Migration[8.0]
  def change
    create_table :feed_monitor_sources do |t|
    ...
    add_index :feed_monitor_sources, :feed_url, unique: true
    add_index :feed_monitor_sources, :active
    add_index :feed_monitor_sources, :next_fetch_at
  end
end
