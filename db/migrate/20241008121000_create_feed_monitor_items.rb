...
class CreateFeedMonitorItems < ActiveRecord::Migration[8.0]
  def change
    create_table :feed_monitor_items do |t|
    ...
    add_index :feed_monitor_items, :guid
    add_index :feed_monitor_items, :content_fingerprint
