...
class CreateFeedMonitorFetchLogs < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :feed_monitor_fetch_logs, :success
    add_index :feed_monitor_fetch_logs, :started_at
    add_index :feed_monitor_fetch_logs, :job_id
    add_index :feed_monitor_fetch_logs, :created_at
  end
end
