...
class CreateFeedmonSources < ActiveRecord::Migration[8.0]
  def change
    create_table :feedmon_sources do |t|
    ...
    add_index :feedmon_sources, :feed_url, unique: true
    add_index :feedmon_sources, :active
    add_index :feedmon_sources, :next_fetch_at
  end
end
