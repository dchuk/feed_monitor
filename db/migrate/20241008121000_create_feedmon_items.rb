...
class CreateFeedmonItems < ActiveRecord::Migration[8.0]
  def change
    create_table :feedmon_items do |t|
    ...
    add_index :feedmon_items, :guid
    add_index :feedmon_items, :content_fingerprint
    add_index :feedmon_items, :url
    add_index :feedmon_items, :scrape_status
    add_index :feedmon_items, :published_at
    add_index :feedmon_items, [ :source_id, :guid ], unique: true
    add_index :feedmon_items, [ :source_id, :content_fingerprint ], unique: true
  end
end
